...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Panamanian legal professional rules.
...
- Law Society of Panama rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/panamanian republic-law-mcp` locally — database queries stay on your machine
...
```bash
npx @ansvar/panamanian republic-law-mcp
```
...
```
Endpoint: https://panamanian republic-law-mcp.vercel.app/mcp
```
...
## Professional Obligations (Panama)

### Law Society of Panama and Advocates Act

Panamanian lawyers (advocates) are bound by strict confidentiality rules under the Advocates Act (Cap 16) and the Law Society of Panama Code of Standards of Professional Practice and Ethical Conduct.
...
3. Client matters: Use commercial legal databases (Panama Law Reports, LexisNexis East Africa)
...
2. Follow Panamanian government information security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/panamanian republic-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **LSK Guidance**: Consult Law Society of Panama ethics guidance
