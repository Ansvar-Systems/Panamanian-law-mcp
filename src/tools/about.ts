...
export function getAbout(db: InstanceType<typeof Database>, context: AboutContext) {
  ...
  return {
    name: 'Panamanian Law MCP',
    version: context.version,
    jurisdiction: 'PA',
    description: 'Panamanian Law MCP — legislation via Model Context Protocol',
    stats,
    data_sources: [
      {
        name: 'Panama Justia',
        url: 'https://panama.justia.com',
        authority: 'Gaceta Oficial de Panama',
      },
    ],
    freshness: {
