/**
 * Tool registry for Panama Law MCP Server.
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'Call this FIRST when you need to understand what Panamanian legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Panamanian statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section/article) from a Panamanian statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate a Panamanian legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Panamanian statutes simultaneously. ' +
  ...
  },
  {
    ...
    description:
      'Format a Panamanian legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether a Panamanian statute or provision is currently in force, amended, or repealed. ' +
